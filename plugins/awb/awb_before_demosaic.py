...
def raw_white_balance(raw_array,pattern='GRBG',bits:int =10):  #raw图的白平衡计算
    ...
    return apply_raw(pattern,R, GR, GB, B,R_gain,G_gain,B_gain,max_value)



    #以下为将白平衡的raw图转化为3通道显示
    ...
    # img[:,:,1] = G
    # img[:,:,2] = B
    # R2, GR2, GB2, B2=bayer_channel_separation(result_image,pattern)
    # img2[:,:,0] = R2
    # img2[:,:,1] = GR2
    # img2[:,:,2] = B2
