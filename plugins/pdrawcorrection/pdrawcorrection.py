...
path_gain="cas_semco_ov48c_m24c64x_pdaf_OTP.txt"
path_pdaf="pdaf.raw"
width_pdaf=496
height_pdaf =750 
bits=10 
...
pdrawcorrection_processor=None
def setParameters(args):

    global path_gain, path_pdaf, width_pdaf, height_pdaf, bits, rawtype, buffertype, pdrawcorrection_processor
    local_params = [path_gain, path_pdaf, width_pdaf, height_pdaf, bits, rawtype, buffertype]
    args.pop()
    i=0
    while i < len(args):
        ...
        i=i+1
    # Call main function
    pdrawcorrection_processor = PDRawCorrection(local_params[0], 
                                local_params[1],
                                local_params[2], 
                                local_params[3],
                                local_params[4], 
                                ...
                                local_params[6])
def run(buffer):
    global pdrawcorrection_processor
    return pdrawcorrection_processor.run()