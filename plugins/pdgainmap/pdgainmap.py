...
def setParameters(args):
    ...
    global path_pdaf, width_pdaf, height_pdaf, path_o, width_o, height_o, bits, rawtype, pattern, buffertype, PDpattern, pdgain_processor
    local_params = [path_pdaf, width_pdaf, height_pdaf, path_o, width_o, height_o, bits, rawtype, pattern, buffertype, PDpattern]
    # print(args)
    args.pop()
    i=0
    while i < len(args):
    ...
    pdgain_processor = PDGainmap(local_params[0], 
                                local_params[1],
                                local_params[2], 
                                local_params[3],
                                local_params[4], 
                                ...
                                local_params[9])
def run(buffer):
    global pdgain_processor
    return pdgain_processor.run()